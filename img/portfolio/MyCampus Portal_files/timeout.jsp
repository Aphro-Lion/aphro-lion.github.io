...
function alertQueryCallback()
{
    ...
    if (alertXmlHttpRequest.readyState == 4)
    {
        if (alertXmlHttpRequest.status == 200)
        {
            ...
            {
                window.top.location.href = "http://portal.mycampus.ca/jsp/misc/timedout.jsp";
            }
            ...
            {
                window.top.location.href = "http://portal.mycampus.ca/cp/home/logout";
            }
...
function checkForWindowClosing()
{
         ...
         window.event.clientY < 0 )   //   the browser window
    {
        ...
        httpGet( logoutXmlHttpRequest, /*URL*/ "http://portal.mycampus.ca/cp/home/logout?src=timeout.jsp" );
    }
}
